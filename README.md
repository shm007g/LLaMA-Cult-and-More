...
- 04/12: DeepSpeed Chatm DeepSpeed from MSFT support RLHF fine-tune with affordable haraware ([blog](https://github.com/microsoft/DeepSpeed/tree/master/blogs/deepspeed-chat))
